...
urlpatterns = [
    ...
    path('password-change/', auth_views.PasswordChangeView.as_view(template_name='dashboard/password_change.html', success_url='/password-change/done/'), name='password_change'),
